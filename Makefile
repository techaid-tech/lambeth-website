...
AWS_S3_BUCKET := lambeth-web-techaid-tech
...
purge-cache:
	docker run --rm -it  -e AWS_ACCESS_KEY -e AWS_SECRET_KEY -e AWS_CF_DISTRIBUTION_ID -e AWS_S3_BUCKET=${AWS_S3_BUCKET} $(REGISTRY)/cf-reset-cache
